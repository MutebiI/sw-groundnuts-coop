        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/gallery" className="text-sm text-amber-100 hover:text-white transition">
                  Gallery
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-amber-100">
              ...
              <li className="flex items-start gap-3">
                <span className="mt-0.5">📞</span>
                <a href="tel:+256772888123" className="hover:text-white transition">
                  +256 772 888 123
                </a>
              </li>
            </ul>

            {/* Social Media Icons - Correct Logos */}
            <div className="mt-4 flex gap-3">
              {/* Facebook */}
              <a
                href="#"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-amber-200 hover:bg-white/20 hover:text-white transition"
                aria-label="Facebook"
              >

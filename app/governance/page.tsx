...
//     <div className={`relative h-16 w-full overflow-hidden ${bg}`}>
//       <svg
...
//       {/* ===== GOVERNANCE STRUCTURE - REDESIGNED WITHOUT CARDS ===== */}
...
//           {/* Vertical line from committee to split */}
...
//           {/* Vertical lines down to each role */}
            ...
            {[
              ...
              >
                <div className="relative p-6 bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-500 hover:-translate-y-1 h-full overflow-hidden">
                  ...
                  <div className="absolute -top-16 -right-16 w-48 h-48 bg-blue-50/50 rotate-12 transform origin-center" />

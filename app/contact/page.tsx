...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
                ...
                {[
                  {
                    icon: "📍",
                    title: "Address",
                    content: "Ahakibungo, Nyamirama T/C\nKanungu District, Uganda",
                  },
                  {
                    icon: "📧",
                    title: "Email",
                  ...
                  >
                    <div className="relative bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition overflow-hidden">
                      <div className={`absolute -right-10 -top-10 w-32 h-32 bg-blue-100/30 blur-xl ${blueShapes[i % blueShapes.length]}`} />
            ...
            >
              <div className="relative bg-white p-8 rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div className={`absolute -right-10 -bottom-10 w-64 h-64 bg-blue-100/20 blur-2xl ${blueShapes[2]}`} />
                  ...
                  <form className="mt-6 space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        required
                        className="mt-1 w-full rounded-lg border border-slate-300 px-4 py-2.5 text-slate-800 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition"
                        placeholder="Enter your name"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        rows={5}
                        required
                        className="mt-1 w-full rounded-lg border border-slate-300 px-4 py-2.5 text-slate-800 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition resize-none"
                        placeholder="Tell us how we can help..."
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full rounded-full bg-blue-600 px-6 py-3 font-medium text-white transition-all hover:bg-blue-700 hover:shadow-lg"
                    >
                      Send Message
                    </button>
                  </form>
      ...
      {/* ===== LOCATION ===== */}
      {/* <section className="relative bg-slate-50/50 py-5">
        <div className="pointer-events-none absolute left-1/2 top-0 h-80 w-80 -translate-x-1/2 rounded-[40%_60%_60%_40%/60%_40%_60%_40%] bg-amber-100/20 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center lg:px-8">
          ...
          <div className="mt-6 inline-block rounded-xl bg-white px-6 py-3 shadow-sm border border-slate-200">
            <p className="text-sm text-slate-600">
              📍 Ahakibungo, Nyamirama T/C, Kanungu District, Uganda
            </p>
          </div>
